...
class c extends e {
    ...
    parse(e, t, o = () => {}) {
        this.decodeDracoFile(e, t, null, null, r).catch(o);
    }
    decodeDracoFile(e, t, r, s, n = o, i = () => {}) {
        const a = {
    ...
    decodeGeometry(e, t) {
        ...
        const s = this.workerNextTaskID++,
            n = e.byteLength,
            i = this._getWorker(s, n)
                .then(
                    (r) => (
                        (o = r),
                        new Promise((r, n) => {
                            (o._callbacks[s] = { resolve: r, reject: n }), o.postMessage({ type: "decode", id: s, taskConfig: t, buffer: e }, [e]);
                        })
                    )
                )
    ...
    _createGeometry(e) {
        ...
        for (let r = 0; r < e.attributes.length; r++) {
            const o = e.attributes[r],
                ...
                a = o.itemSize,
                c = new n(i, a);
            "color" === s && (this._assignVertexColorSpace(c, o.vertexColorSpace), (c.normalized = i instanceof Float32Array == !1)),
                t.setAttribute(s, c);
        }
        return t;
    }
    _assignVertexColorSpace(e, t) {
        if (t !== r) return;
        const o = new i();
        for (let t = 0, r = e.count; t < r; t++) o.fromBufferAttribute(e, t).convertSRGBToLinear(), e.setXYZ(t, o.r, o.g, o.b);
    }
    _loadLibrary(e, r) {
    ...
    _initDecoder() {
        ...
        return (
            ...
            (this.decoderPending = Promise.all(t).then((t) => {
                ...
                const o = d.toString(),
                    s = ["/* draco decoder */", r, "", "/* worker */", o.substring(o.indexOf("{") + 1, o.lastIndexOf("}"))].join("\n");
...
function d() {
    ...
    function r(e, t, r, o, s, n) {
        const i = n.num_components(),
            a = r.num_points() * i,
            c = a * s.BYTES_PER_ELEMENT,
            d = (function (e, t) {
                switch (t) {
                    case Float32Array:
                        return e.DT_FLOAT32;
            ...
            l = e._malloc(c);
        t.GetAttributeDataArrayForAllPoints(r, n, d, c, l);
        const u = new s(e.HEAPF32.buffer, l, a).slice();
        return e._free(l), { name: o, array: u, itemSize: i };
    }
                ...
                t.then((e) => {
                    ...
                    try {
                        const e = (function (e, t, o, s) {
                                ...
                                if (d === e.TRIANGULAR_MESH) (a = new e.Mesh()), (c = t.DecodeArrayToMesh(o, o.byteLength, a));
                                else {
                                    if (d !== e.POINT_CLOUD) throw new Error("THREE.DRACOLoader: Unexpected geometry type.");
                                    (a = new e.PointCloud()), (c = t.DecodeArrayToPointCloud(o, o.byteLength, a));
                                }
                                ...
                                for (const o in n) {
                                    const c = self[i[o]];
                                    let d, u;
                                    if (s.useUniqueIDs) (u = n[o]), (d = t.GetAttributeByUniqueId(a, u));
                                    else {
                                        if (((u = t.GetAttributeId(a, e[n[o]])), -1 === u)) continue;
                                        d = t.GetAttribute(a, u);
                                    }
                                    const h = r(e, t, a, o, c, d);
                                    "color" === o && (h.vertexColorSpace = s.vertexColorSpace), l.attributes.push(h);
                                }
                                d === e.TRIANGULAR_MESH &&
                                    (l.index = (function (e, t, r) {
                                        ...
                                        const a = new Uint32Array(e.HEAPF32.buffer, i, s).slice();
                                        return e._free(i), { array: a, itemSize: 1 };
                                    })(e, t, a));
                                return e.destroy(a), l;
                            })(t, i, new Int8Array(o), n),
                            a = e.attributes.map((e) => e.array.buffer);
                        e.index && a.push(e.index.array.buffer), self.postMessage({ type: "decode", id: s.id, geometry: e }, a);
                    } catch (e) {
                        console.error(e), self.postMessage({ type: "error", id: s.id, error: e.message });
                    } finally {
                        t.destroy(i);
                    }
                });
...
export { c as DRACOLoader };
export default null;
//# sourceMappingURL=/sm/cc685767a51df58ebabb0a42e6f17c4779ae00527ca4fd9f5e1e6391a79ca362.map
